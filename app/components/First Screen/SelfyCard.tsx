...
export default function SelfyCard() {
  return (
    <div className="bg-gradient-to-t from-zinc-950 to-zinc-700 py-5 sm:px-10 px-8 rounded-xl flexcolcenter gap-5 max-w-96 h-[480px]">
      <img
        className="rounded-xl w-72 shadow-lg shadow-white/80"
        src="https://portfoliophilpynson.s3.eu-north-1.amazonaws.com/MEPORTFOLIO.jpg"
        alt=""
      />
      <div className="text-slate-200 flexcolcenter gap-5">
        ...
        <p className="text-center text-lg">Looking for internship near Toulouse</p>
      </div>
    </div>
  );
}
